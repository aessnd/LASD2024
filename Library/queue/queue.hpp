...
public:
  ...
  // Copy assignment
  Queue& operator=(const Queue<Data>&)=delete; // Copy assignment of abstract types is not possible.

  // Move assignment
  Queue& operator=(Queue<Data>&&)noexcept=delete; // Move assignment of abstract types is not possible.
